  ...
  if ($auto) {
    ...
    <table width="720" border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      foreach ($auto as $k => $v) {
        ...
        $contador++;
        ?>
        <form name="a<?php echo $v['identificador'] ?>" method="post" action="agregarauto.php?<?php echo SID ?>"
          ...
          <tr bgcolor="<?php echo $color[$contador % 2]; ?>" class='prod'>
            ...
            <td align="center"><a href="borrarauto.php?<?php echo SID ?>&id=<?php echo $v['id'] ?>"><img src="trash.gif"
    ...
    <div align="center"><span class="prod">Total de Artículos: <?php echo count($auto); ?></span>
    </div><br>
